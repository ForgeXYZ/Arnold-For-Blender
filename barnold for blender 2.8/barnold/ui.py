...
class ArnoldLightPanel(LightButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        col = layout.column()
        if light_type not in ('SUN', 'HEMI') and light_type != 'photometric_light':
        ...
        if light_type in ('POINT', 'SPOT'):
            ...
            if light_type == 'cylinder_light':
                ...
                col.prop(light, "samples")
                col.prop(light, "shape", expand=True)
        ...
        if light_type == 'SPOT':
            ...
            col.prop(light, "spot_size", text="Cone Ange")
...
class ArnoldShaderPanel(MaterialButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        # TODO: mat.type does not exist anymore...
        mat_type = mat.type
        if mat_type == 'SURFACE':
